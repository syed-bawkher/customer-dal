...
router.get("/jacketMeasurement/customer/:id", passport.authenticate('bearer', { session: false }), async (req, res) => {
...
router.get("/jacketMeasurement/order/:orderNo", passport.authenticate('bearer', { session: false }), async (req, res) => {
...
router.post("/jacketMeasurement/:customerid/:orderNo", passport.authenticate('bearer', { session: false }), async (req, res) => {
    try {
...
router.put("/jacketMeasurement/:measurementId", passport.authenticate('bearer', { session: false }), async (req, res) => {
    try {
